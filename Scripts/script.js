...
const setBackgroundImage = (screen) => {
  switch (screen) {
    case bossScreen:
      gameContainer.style.backgroundImage = "url(PerguntadosADM/Images/BossBackground.png)";
      break;
    default:
      gameContainer.style.backgroundImage = "url(PerguntadosADM/Images/MainBackground.jpg)";
  }
};
